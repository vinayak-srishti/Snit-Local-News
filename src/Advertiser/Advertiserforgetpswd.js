...
function Advertiserforgetpswd() {
  ...
  const handlesubmit = (e) => {
    ...
    if (!passwordError && !confirmPasswordError) {
      ...
      axiosInstance.post(`/advertiserforgetpswd`, password)
        .then((result) => {
          console.log(result);
  ...
  return (
    <div>
        ...
        <div className='col-sm-12 contributer_image'>
          <Link to="/advertiserlogin"> <img src={img} alt="image" height="40px" width="40px" /></Link>
        </div>
...
export default Advertiserforgetpswd